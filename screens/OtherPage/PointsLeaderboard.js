...
export default function PointsLeaderboard({ }) {
  ...
  // Player data
  const playerData = [
    { name: "Nathan Sobey", rank: 1, gp: 27, ppg: 20.15, fga: 15.48, rpg: 4.41, fgm: 6.22, fgPercentage: 40.2, threePA: 6.52, threePM: 1.81, threePPercentage: 27.8, fta: 6.85, ftm: 5.89, ftPercentage: 85.9, apg: 2.56, bpg: 0.22, spg: 1, tpg: 2.33, f: 130, pos: 'G' },
    { name: "Josh Bannan", rank: 2, gp: 19, ppg: 11.95, fga: 10.53, rpg: 7.21, fgm: 4.74, fgPercentage: 45.0, threePA: 1.74, threePM: 0.58, threePPercentage: 33.3, fta: 2.53, ftm: 1.89, ftPercentage: 75.0, apg: 1.53, bpg: 0.21, spg: 0.42, tpg: 1.26, f: 38, pos: 'F' },
    { name: "Chris Smith", rank: 3, gp: 27, ppg: 11, fga: 9.59, rpg: 2.93, fgm: 4, fgPercentage: 41.7, threePA: 5.15, threePM: 1.63, threePPercentage: 31.7, fta: 1.89, ftm: 1.37, ftPercentage: 72.5, apg: 1.11, bpg: 0.26, spg: 0.56, tpg: 1.11, f: 48, pos: 'G' },
    { name: "Tyrell Harrison", rank: 4, gp: 27, ppg: 9.56, fga: 6.52, rpg: 6.22, fgm: 3.81, fgPercentage: 58.5, threePA: 0.07, threePM: 0.04, threePPercentage: 50.0, fta: 2.96, ftm: 1.89, ftPercentage: 63.7, apg: 0.52, bpg: 1.41, spg: 0.52, tpg: 1.63, f: 66, pos: 'C' },
    ...
    { name: "Aron Baynes", rank: 6, gp: 23, ppg: 7.3, fga: 5.35, rpg: 4.26, fgm: 2.57, fgPercentage: 48.0, threePA: 1.09, threePM: 0.35, threePPercentage: 32.0, fta: 2.3, ftm: 1.83, ftPercentage: 79.2, apg: 0.52, bpg: 0.39, spg: 0.13, tpg: 1.39, f: 48, pos: 'C' },
    { name: "Mitch Norton", rank: 7, gp: 28, ppg: 7.11, fga: 5.75, rpg: 2.21, fgm: 2.36, fgPercentage: 41.0, threePA: 1.79, threePM: 0.64, threePPercentage: 36.0, fta: 2.43, ftm: 1.75, ftPercentage: 72.1, apg: 2.71, bpg: 0.04, spg: 0.82, tpg: 1.25, f: 70, pos: 'G' },
    { name: "Isaac White", rank: 8, gp: 28, ppg: 7, fga: 5.89, rpg: 2.04, fgm: 2.79, fgPercentage: 47.3, threePA: 1.54, threePM: 0.32, threePPercentage: 20.9, fta: 1.54, ftm: 1.11, ftPercentage: 72.1, apg: 1.46, bpg: 0, spg: 0.29, tpg: 0.68, f: 42, pos: 'G' },
    ...
    { name: "DJ Mitchell", rank: 10, gp: 15, ppg: 5, fga: 3.8, rpg: 2.93, fgm: 1.93, fgPercentage: 50.9, threePA: 2, threePM: 0.87, threePPercentage: 43.3, fta: 0.4, ftm: 0.27, ftPercentage: 66.7, apg: 0.93, bpg: 0.33, spg: 0.53, tpg: 0.87, f: 6, pos: 'F' },
    ...
    { name: "Rocco Zikarsky", rank: 12, gp: 27, ppg: 3.22, fga: 2.3, rpg: 2.11, fgm: 1.37, fgPercentage: 59.7, threePA: 0.04, threePM: 0, threePPercentage: 0, fta: 0.96, ftm: 0.48, ftPercentage: 50.0, apg: 0.15, bpg: 1, spg: 0.11, tpg: 0.56, f: 21, pos: 'C' },
    { name: "Gabe Hadley", rank: 13, gp: 6, ppg: 0.17, fga: 1, rpg: 0, fgm: 0, fgPercentage: 0, threePA: 0.5, threePM: 0, threePPercentage: 0, fta: 0.33, ftm: 0.17, ftPercentage: 50.0, apg: 0, bpg: 0, spg: 0, tpg: 0, f: 0, pos: 'G' },
    { name: "Matthew Johns", rank: 14, gp: 13, ppg: 0, fga: 0.31, rpg: 0.77, fgm: 0, fgPercentage: 0, threePA: 0.23, threePM: 0.08, threePPercentage: 0.23, fta: 0, ftm: 0, ftPercentage: 0, apg: 0.15, bpg: 0, spg: 0.08, tpg: 0.23, f: 1, pos: 'PF' },
