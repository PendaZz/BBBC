  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <TouchableOpacity style={styles.bstoreButton} onPress={() => navigation.navigate("B-Store")}>
          <Text style={styles.bstoreButtonText}>Back</Text>
        </TouchableOpacity>
        <View style={styles.headerContainer}>
          <Text style={styles.FeaturedText}>SUPPORTER</Text>
        </View>
        ...
        <View style={[styles.sidebar, { width: width * 0.4 }]}>
          ...
          >
            <Text
              style={[
                styles.sidebarText,
                route.name === "OfficialKit" && styles.activeSidebarText,
              ]}
            >
              OFFICIAL KIT
            </Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Supporter")}>
            <Text
              style={[
                styles.sidebarText,
                route.name === "Supporter" && styles.activeSidebarText,
              ]}
            >
              SUPPORTER
            </Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Accessories")}>
            <Text
              style={[
                styles.sidebarText,
                route.name === "Accessories" && styles.activeSidebarText,
              ]}
            >
              ACCESSORIES
            </Text>
